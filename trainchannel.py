...
save_path = f'channel_checkpoints/cldnn/trial{trial}/{n_channels}/'
checkpoint_model = f'channel_checkpoints/cldnn/trial{trial}/{n_channels}/model_{current_time}'
...
def main():
    ...
    train_dataset = ChannelDataset(mode="train", n_channels=n_channels, importance_matrix=importance_matrix, trial=trial)
